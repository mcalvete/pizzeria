//
//  QuesoTableViewController.swift
//  pizzeria
//
...
protocol QuesoUpdateProtocol: class {
    func updatePizzaInformation(pizza: Pizza)
}

class QuesoTableViewController: UITableViewController, IngredientesUpdateProtocol {
    var delegate : QuesoUpdateProtocol?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.pizza?.queso = (cell?.textLabel!.text)!
